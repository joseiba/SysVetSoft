...
from apps.ventas.producto.views import add_tipo_producto, list_tipo_producto, edit_tipo_producto, search_tipo_producto, add_deposito, list_deposito, edit_deposito, search_deposito

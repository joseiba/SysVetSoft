    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_vacuna', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='configuracion.tipovacuna')),
            ],
            options={
                'verbose_name': 'Ficha Medica',
                'verbose_name_plural': 'Fichas Medicas',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vacuna', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='configuracion.tipovacuna')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proximo_tratamiento', models.CharField(blank=True, default='-', max_length=500, null=True)),
                ('medicamento', models.CharField(blank=True, default='-', max_length=500, null=True)),
                ('id_ficha_medica', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mascota.fichamedica')),
            ],
            options={

# Generated by Django 3.1.5 on 2021-03-05 02:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_vencimiento', models.DateField(blank=True, default='11/11/1111', help_text='Ingrese fecha de vencimiento', null=True)),
                ('fecha_baja', models.DateField(blank=True, default='11/11/1111', help_text='Ingrese fecha de baja', null=True)),
                ('fecha_movimiento', models.DateField(blank=True, default='11/11/1111', help_text='Ingrese fecha de movimiento', null=True)),
                ...
                ('ubicacion', models.CharField(help_text='Ingrese ubicacion del producto', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_alta', models.CharField(default='04/03/2021 22:42:20 hs', editable=False, max_length=200)),

...
class ProductoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'fecha_vencimiento' : forms.TextInput(attrs={'class':'form-control fecha_vencimiento','type':'text', 'autocomplete': 'off' ,'id':'datepicker' ,'name': 'fecha_vencimiento', 
            ...
            'lote': forms.TextInput(attrs={'class':'form-control', 'name': 'lote', 'placeholder': 'Lote', 'autocomplete': 'off' ,'id':'lote_id','onkeyup':'replaceDirection(this)'}),
